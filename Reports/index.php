...
<div class="container">
    <h3>Reports of sale</h3>
    <form id="form1" name="form1" method="POST" action="../TCPDF/rptEjemplo.php">
          <div class="row">
          ...
          <div class="row">
          <button  class="btn waves-effect waves-light" type="submit" name="action">Report
