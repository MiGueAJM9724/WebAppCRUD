...
<div class="container">
    <form id="form1" name="form1" method="POST" action="chartdepartament.php">
    <div class="row">
          ...
          <div class="row">
                <div class="input-field col s6">
                    <select name="id_departament" id="id_departament">
                         <?php include_once("./selectdepartament.php"); ?>
                    </select>
                    <label for="id_departament">Departament</label>
                 </div>
          </div>
          <div class="row">
